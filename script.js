...
const containerPass = document.querySelector("#container-pass");
...
function gerarSenha(){
    ...
    for(let i=0, n = caracteres.length; i < slide.value; i++){
        ...
        //charAt() = pega uma posição na string, definida dentro dos parenteses; Math.floor() = retorna o menor numero inteiro dentro de um numero (x); Math.random() = gera um numero aleatorio.
    }

    containerPass.classList.remove("hide"); 
    //Remove a classe hide, quando a função é chamada
